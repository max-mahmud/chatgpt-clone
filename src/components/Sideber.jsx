  ...
  return (
    <div>
        ...
        <div className="content custom-scrollbar text-white ">
          ...
          >
            <div className="flex gap-2 items-center">
              <img src="/parrot.png" alt="logo" className="bg-white rounded-full w-7 h-7 p-[2px]" />
              <h3 className="text-[13px] font-medium">Parrot-GPM</h3>
            </div>
            <span>
              <FaRegEdit />
            </span>
      ...
      <div
        ...
        className={` ${
          responsive ? " top-0 right-0  bottom-0 left-0 transition-all   duration-200 " : "-left-96  "
        } absolute lg:hidden z-50  bg-[#07070736]`}
      >
        <div className={` ${" w-64 "}  sideber absolute top-0 left-0 bottom-0  z-[999] `}>
          <span
            onClick={() => setResponsive(false)}
